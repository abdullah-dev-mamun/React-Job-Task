...
const Footer = () => {
  return (
    <section className="bg-dark-secondary pt-8 pb-4 text-white">
      <div className="container_section grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-10 3xl:gap-20">
        <div>
          <Slide direction="left" duration={2000}>
            <img src={brandLogo} alt="" />
          </Slide>
          <Slide direction="left" duration={2500}>
            <p className="w-full max-w-xs mt-4">
              A premium quality brand of sanitary ware in collaboration with the
              ceramic giant SACMI of Italy.
            </p>
          </Slide>
        </div>
        <div className="md:pl-20">
          <Fade cascade damping={0.1}>
            ...
            <ul>
              <li className="nav_list group block mx-0">
                <Link
                  to=""
                  className="nav_link group-hover:after:w-full text-base"
                >
                  Privacy Notice
                </Link>
              </li>
        ...
        <div>
          ...
          <Slide direction="right" duration={2500}>
            <div className="social_section my-6 flex gap-4">
      ...
      <p className="text-center pt-5 mt-5 border-t border-white">
