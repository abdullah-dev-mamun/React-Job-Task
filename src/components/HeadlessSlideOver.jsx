    ...
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <Dialog.Overlay className="absolute inset-0 bg-dark-primary/60 transition-opacity" />
        </Transition.Child>
            ...
            <div className="relative w-screen max-w-[250px]">
              ...
              >
                <button
                  ...
                  className="absolute group right-6 top-6"
                >
              ...
              <div className="h-full  bg-dark-primary/95  overflow-hidden">
                <div className="w-full mt-28 relative  flex justify-center items-center">
